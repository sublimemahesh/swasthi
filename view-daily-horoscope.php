                        ...
                        <div class="tab-content">
                            <div id="home" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <?php
                                    $signs = Sign::all();
                                    $daily_details = DailyHoroscope::getHoroscopeDetailsByDateAndSign($id);
                                        foreach ($signs as $key => $sign) {
                                            if ($id == $key+1) {
                                                ?>
                                                <div class="col-lg-6 col-md-6 col-md-offset-3 col-sm-6 col-xs-12" id="div_<?php echo $key; ?>" tabindex="1">
                                                    <div class="hs_kd_service_main_box_wrapper">
                                                        <div class="hs_kd_service_inner_box_wrapper horoscope-box">
                                                            ...
                                                            <div class="hs_kd_ser_img_cont_wrapper">
                                                                ...
                                                                <p><?php echo $daily_details['description']; ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
