...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#8d8e90">
        ...
        . '<img src="' . $site_link . '/appointment-form/img/logo.jpg" width="90" border="0" alt=""/>
                                            </a>
                                        </td>
                                        <td width="393">
                        ...
                        <tr>
                           <td align="center">
                                <img src="https://drive.google.com/uc?export=view&id=1gkQwGflIcmEoBE6JESe8GtsnU6-UXJcA" alt="" width="598" height="323" border="0"/>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="96%" align="center" style="border-bottom:1px solid #000000" height="50">
                                            <font style="font-family: Verdana, Geneva, sans-serif; color:#1400FF; font-size:18px; " >
                                                   <h4> Appointment Enquiry - ' . $comany_name . '</h4>
                                            </font>
                                        </td>
                                        <td width="2%">&nbsp;</td>
                                    </tr>
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="90%" valign="middle">
                                            <font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:14px; " >
                                               Thank you for visiting ' . $website_name . ' web site and make an appointment. Your enquiry has been sent to ' . $comany_name . ' and one of representative will be contact you shortly. 
                                            </font>
                                        </td>
                                        <td width="5%">&nbsp;</td>
                                    </tr>
                                     <tr>
                                        ...
                                        <td width="90%" valign="middle">
                                            <font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:14px; " >
                                               The details of your appointment are shown below.
                                            </font>
                                        </td>
                                        <td width="5%">&nbsp;</td>
                                    </tr>
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="90%" valign="middle">
                                            <font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:14px; " >
                                               You have a new appointment from your website on ' . $todayis . ' as follows. Please pay your attention as soon as possible.
                                            </font>
                                        </td>
                                        <td width="5%">&nbsp;</td>
                                    </tr>
