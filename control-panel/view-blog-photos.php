                            ...
                            <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    if (count($BLOG_PHOTO) > 0) {
                                            ...
                                            <div class="col-md-3"  id="div<?php echo $blog_photo['id']; ?>">
                                                ...
                                                <div class="img-caption">
                                                    ...
                                                    <div class="d">
                                                        ...
                                                        <a href="arrange-blog-photos.php?id=<?php echo $id; ?>">  <button class="glyphicon glyphicon-random arrange-btn"></button></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
                                        ...
                                        ?> 
                                        <b style="padding-left: 15px;">No blog photos in the database.</b> 
                                    <?php } ?> 
