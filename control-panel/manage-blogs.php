                                ...
                                <div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        if (count($BLOG) > 0) {
                                            foreach ($BLOG as $key => $blog) {
                                                ...
                                                <div class="col-md-3"  id="div<?php echo $blog['id']; ?>">
                                                    <div class="photo-img-container">
                                                        <img src="../upload/blog/thumb/<?php echo $blog['image_name']; ?>" class="img-responsive ">
                                                    </div>
                                                    <div class="img-caption">
                                                        ...
                                                        <div class="d">
                                                            ...
                                                            <a href="arrange-blogs.php?id=<?php echo $blog['id']; ?>">  <button class="glyphicon glyphicon-random arrange-btn"></button></a>
                                            ...
                                            ?> 
                                            <b style="padding-left: 15px;">No blogs in the database.</b> 
                                            <?php
                                        }
                                        ?> 
