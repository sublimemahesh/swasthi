                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="hs_footer_logo_wrapper">
                            <a href="./"><img src="images/content/footer-logo.png" alt="footer_logo" class="img-responsive" /></a>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="footer_bottom_cont_wrapper">
                            ...
                            <p>© Copyright - <?php echo date('Y'); ?> Swasthi.lk. All right Reserved - Design By <a href="https://www.synotec.lk/" target="_blank"title="">- Synotec Holdings (pvt) Ltd</a></p>
                        </div>
                    </div>
                </div>
            </div>
